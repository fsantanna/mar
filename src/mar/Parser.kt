...
fun parser_type (pre: Tk?, fr_proto: Boolean, fr_hier: Boolean): Type {
    return when {
        ...
        accept_op("\\") -> {
            ...
            val ptr = parser_type(null, false, false)
        ...
        accept_op("<") -> {
            ...
            val ts = parser_list(",", ">") {
                ...
                when {
                    ...
                    (tk1 is Tk.Type) -> parser_type(tk1, false, false)
                    else -> parser_type(null, false, false)
                }
            }
            if (ids.isEmpty()) {
