...
fun Type.is_sup_of (other: Type): Boolean {
    return when {
        ...
        (this is Type.Proto.Func && other is Type.Proto.Func) -> (this.inp.size==other.inp.size) && this.inp.zip(other.inp).all { (thi,oth) -> thi.is_sup_of(oth) } && other.out.is_sup_of(this.out)
        (this is Type.Proto.Coro && other is Type.Proto.Coro) -> (this.inp.size==other.inp.size) && this.inp.zip(other.inp).all { (thi,oth) -> thi.is_sup_of(oth) } && other.out.is_sup_of(this.out)
