...
class Lexer {
    ...
    @Test
    fun bb_01_ids() {
        val tks = ("if xxx Type coro match task break it until while return escape await emit loop throw defer exec create spawn data start catch resume yield where").lexer()
